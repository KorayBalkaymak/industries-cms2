...
export default function WhyUsSection() {
  const { sectionRef, lineProgress, visible } = useReveal(whyUs.length);
  const activeCount = Math.min(whyUs.length, Math.ceil(lineProgress * whyUs.length));
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-white py-24">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 20% 20%, rgba(255,87,34,0.06) 0, transparent 40%), radial-gradient(circle at 80% 80%, rgba(11,19,43,0.04) 0, transparent 42%)',
        }}
        aria-hidden
      />
      ...
      <div className="container-px relative">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="section-title mt-3">Warum Industries CMS?</h2>
        ...
        <div className="relative mt-16">
          ...
          <div className="grid items-stretch gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-5">
            {whyUs.map((item, index) => {
              const WhyIcon = item.icon as LucideIcon;
              ...
              return (
                ...
                >
                  <div className="home-card-glow-light absolute -inset-px rounded-2xl opacity-0 transition-opacity duration-500 group-hover:opacity-100" aria-hidden />
                  <div
                  ...
                  >
                    ...
                    >
                      <WhyIcon className="h-7 w-7" strokeWidth={1.75} />
                    </span>
